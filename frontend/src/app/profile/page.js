...
export default function ProfilePage() {
  ...
  const mockBadges = [
    {
      name: 'First Reporter',
      icon: '🏆',
      description: 'Submitted your first emergency report',
    },
    {
    ...
    },
    {
      ...
      icon: '⚡',
      description: 'Responded to emergencies within 5 minutes',
    },
  ];
  ...
  const mockRecentActivity = [
    {
      date: '2024-01-15',
      action: 'Reported flood on Main Street',
      type: 'report',
    },
    {
      date: '2024-01-12',
      action: 'Received storm warning alert',
      type: 'alert',
    },
    {
      date: '2024-01-10',
        ...
        <div className='container mx-auto px-4 py-8 max-w-4xl'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-gray-600'>
              Manage your account information and emergency settings
            </p>
            ...
            <div className='mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-sm text-yellow-800 font-medium'>
                  Note: This page uses mock data. Backend integration to be
                  implemented later.
                </span>
              </div>
            </div>
                ...
                <CardContent>
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                    {mockBadges.map((badge, index) => (
                      <div
                        key={index}
                        className='text-center p-4 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg border'>
