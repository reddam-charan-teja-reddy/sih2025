...
export default function SettingsPage() {
  ...
  const SettingItem = ({ label, description, checked, onChange, category, settingKey }) => (
    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
      <div className="flex-1">
        <Label htmlFor={`${category}-${settingKey}`} className="text-sm font-medium">
          {label}
        </Label>
        {description && (
      ...
      <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50'>
        ...
        <div className='container mx-auto px-4 py-8 max-w-4xl'>
          ...
          <div className='mb-8'>
            ...
            <p className='text-gray-600'>Customize your emergency management preferences</p>
            ...
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-yellow-800 font-medium">
                  Note: Settings are saved locally. Backend integration to be implemented later.
                </span>
              </div>
            </div>
          </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <SettingItem
                    ...
                    onChange={(value) => handleSettingChange('notifications', 'reportUpdates', value)}
                  />
                  <SettingItem
                    category="notifications"
                  ...
                  <SettingItem
                    ...
                    onChange={(value) => handleSettingChange('notifications', 'quietHours', value)}
                  />
                  <SettingItem
                    category="notifications"
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <SettingItem
                    ...
                    onChange={(value) => handleSettingChange('map', 'showReports', value)}
                  />
                  <SettingItem
                    category="map"
                    ...
                    onChange={(value) => handleSettingChange('map', 'showAlerts', value)}
                  />
                  <SettingItem
                    category="map"
                    ...
                    onChange={(value) => handleSettingChange('map', 'autoCenter', value)}
                  />
                  <SettingItem
                    category="map"
                    ...
                    onChange={(value) => handleSettingChange('map', 'clusterMarkers', value)}
                  />
                  <SettingItem
                    category="map"
                    ...
                    onChange={(value) => handleSettingChange('map', 'satelliteView', value)}
                  />
                  <SettingItem
                    category="map"
                    ...
                    onChange={(value) => handleSettingChange('map', 'trafficLayer', value)}
                  />
                </CardContent>
              </Card>
            </TabsContent>
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <SettingItem
                    ...
                    onChange={(value) => handleSettingChange('privacy', 'anonymousReporting', value)}
                  />
                  <SettingItem
                    category="privacy"
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <SettingItem
                    ...
                    onChange={(value) => handleSettingChange('display', 'largeText', value)}
                  />
                  <SettingItem
                    category="display"
                    ...
                    onChange={(value) => handleSettingChange('display', 'reduceMotion', value)}
                  />
                  <SettingItem
                    category="display"
